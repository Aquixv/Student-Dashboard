  ...
  return (
    <div className="layout-wrapper" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#f8fafc' }}>
      ...
      <div className="mobile-header">
        <h2 style={{ color: '#095DC5', margin: 0, fontSize: '1.3rem', fontWeight: 800 }}>Admin Portal</h2>
        <button 
      ...
      {/* --- DASHBOARD BODY (Groups Sidebar and Main Content together) --- */}
      <div className="dashboard-body" style={{ display: 'flex', flex: 1 }}>
        
        {/* --- SIDEBAR --- */}
        <aside 
          className={`sidebar-nav ${isMobileMenuOpen ? 'open' : ''}`} 
          style={{ width: '260px', backgroundColor: 'white', borderRight: '1px solid #e2e8f0', padding: '2rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}
        >
          <div className="desktop-logo" style={{ padding: '0 1rem', marginBottom: '2.5rem' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '0.85rem', margin: 0, fontWeight: 500 }}>Control Center</p>
          </div>
          ...
          <button 
            onClick={() => navigate('/')}
            style={{
              marginTop: 'auto', display: 'flex', alignItems: 'center', gap: '8px', padding: '0.75rem 1rem', border: '1px solid #e2e8f0', borderRadius: '8px', background: '#f8fafc', color: '#64748b', fontSize: '0.85rem', fontWeight: 600, cursor: 'pointer'
            }}
          >
        ...
        {/* --- MAIN WORKSPACE --- */}
        <main className="main-content" style={{ flex: 1, padding: '2.5rem 3.5rem', overflowY: 'auto' }}>
